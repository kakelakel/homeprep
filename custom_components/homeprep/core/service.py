...
class HomePrepService:
    ...
    async def async_update_item(
        ...
        clean_updates["revision"] = int(
            item.get("revision", 1)
        ) + 1

        result = await self._repository.async_update_item(
            item_id,
            clean_updates,
        )
    ...
    async def async_delete_item(
        ...
        result = await self._repository.async_delete_item(
            item_id
        )
